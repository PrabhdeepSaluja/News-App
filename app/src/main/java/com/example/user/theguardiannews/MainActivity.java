...
public  class MainActivity extends AppCompatActivity
    ...
    // Url= "http://content.guardianapis.com/search?q=debates&api-key=test"
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        articleListView = (ListView) findViewById(R.id.article_list_view);
        ...
        if (checkNetworkConnection()) {
            ...
            // Use getSupportLoaderManager if MainActivity.this is showing error
    ...
    private void handleQuery(String searchStringQ) {
        ...
        getSupportLoaderManager().restartLoader(ARTICLE_LOADER_ID, args, MainActivity.this);
        articleListView.smoothScrollToPosition(0);
    }

    @NonNull
    @Override
    public Loader<List<ArticleData>> onCreateLoader(int i, @Nullable Bundle args) {
